$(function () {
    ...
    $('a[name=delete_dimension_type]').on('click', function () {

        if (window.confirm("Do you really want to delete the Dimension type?")) {
            var csrftoken = getCookie('csrftoken');
            $.ajaxSetup({
                beforeSend: function (xhr, settings) {
                    if (!csrfSafeMethod(settings.type) && !this.crossDomain) {
    ...
    $('a[name=delete_dimension]').on('click', function () {

        if (window.confirm("Do you really want to delete the Dimension?")) {
            var csrftoken = getCookie('csrftoken');
            $.ajaxSetup({
                beforeSend: function (xhr, settings) {
                    if (!csrfSafeMethod(settings.type) && !this.crossDomain) {
